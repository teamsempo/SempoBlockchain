...
standard_user = partial(UserFactory, pin='0000', failed_pin_attempts=0)
two_failed_pin_attempts_user = partial(UserFactory, pin='0000', failed_pin_attempts=2)
one_failed_pin_attempts_user = partial(UserFactory, pin='0000', failed_pin_attempts=1)
pin_blocked_user = partial(UserFactory, pin='0000', failed_pin_attempts=3)
...
@pytest.mark.parametrize("session_factory, user_factory, user_input, expected, failed_pin_attempts",
                         [
                             ...
                             (send_token_pin_authorization_state, one_failed_pin_attempts_user, "1212",
                              "send_token_pin_authorization", 2),
                             (send_token_pin_authorization_state, one_failed_pin_attempts_user, "0000",
                              "send_token_confirmation", 0),
                             (send_token_pin_authorization_state, two_failed_pin_attempts_user, "1212",
                              "exit_pin_blocked", 3),
                             (send_token_pin_authorization_state, two_failed_pin_attempts_user, "0000",
                              "send_token_confirmation", 0)
                         ])
def test_exit_pin_blocked(test_client, init_database, session_factory, user_factory, user_input, expected,
                          failed_pin_attempts):
    session = session_factory()
    user = user_factory()
