...
initial_language_selection_state = partial(UssdSessionFactory.build, state="initial_language_selection")
initial_pin_entry_state = partial(UssdSessionFactory.build, state="initial_pin_entry")
initial_pin_confirmation_state = partial(UssdSessionFactory.build, state="initial_pin_confirmation", user_input="0000*0000")
start_state = partial(UssdSessionFactory.build, state="start")
send_enter_recipient_state = partial(UssdSessionFactory.build, state="send_enter_recipient")
send_token_amount_state = partial(UssdSessionFactory.build, state="send_token_amount")
send_token_reason_state = partial(UssdSessionFactory.build, state="send_token_reason")
send_token_reason_other_state = partial(UssdSessionFactory.build, state="send_token_reason_other")
send_token_pin_authorization_state = partial(UssdSessionFactory.build, state="send_token_pin_authorization")
send_token_confirmation_state = partial(UssdSessionFactory.build, state="send_token_confirmation")
account_management_state = partial(UssdSessionFactory.build, state="account_management")
my_business_state = partial(UssdSessionFactory.build, state="my_business")
choose_language_state = partial(UssdSessionFactory.build, state="choose_language")
balance_inquiry_pin_authorization_state = partial(UssdSessionFactory.build, state="balance_inquiry_pin_authorization")
current_pin_state = partial(UssdSessionFactory.build, state="current_pin")
new_pin_state = partial(UssdSessionFactory.build, state="new_pin")
new_pin_confirmation_state = partial(UssdSessionFactory.build, state="new_pin_confirmation", user_input="2222*2222")
opt_out_of_market_place_pin_authorization_state = partial(UssdSessionFactory.build, state="opt_out_of_market_place_pin_authorization")
exchange_token_state = partial(UssdSessionFactory.build, state="exchange_token")
exchange_rate_pin_authorization_state = partial(UssdSessionFactory.build, state="exchange_rate_pin_authorization")
exchange_token_agent_number_entry_transitions_state = partial(UssdSessionFactory.build, state="exchange_token_agent_number_entry_transitions")
exchange_token_amount_entry_state = partial(UssdSessionFactory.build, state="exchange_token_amount_entry")
exchange_token_pin_authorization_state = partial(UssdSessionFactory.build, state="exchange_token_pin_authorization")
exchange_token_confirmation_state = partial(UssdSessionFactory.build, state="exchange_token_confirmation")
