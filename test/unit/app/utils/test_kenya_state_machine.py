...
@pytest.mark.parametrize("session_factory, user_factory, user_input, expected",
                         [
                             ...
                             (initial_language_selection_state, standard_user, "1", "complete"),
                             (initial_language_selection_state, standard_user, "2", "complete"),
                             ...
                             (choose_language_state, standard_user, "1", "complete"),
                             (choose_language_state, standard_user, "2", "complete"),
                             ...
                             # (opt_out_of_market_place_pin_authorization, standard_user, "0000", "change_opted_in_market_status"),
                             # (opt_out_of_market_place_pin_authorization, standard_user, "1111", "exit_pin_blocked"),
