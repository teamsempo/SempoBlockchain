...
from server.utils.user import transfer_usages_for_user, send_onboarding_sms_messages, admin_reset_user_pin, process_create_or_modify_user_request
...
def test_create_transfer_account_user(
    ...
    assert process_create_or_modify_user_request(
        attribute_dict=dict(
