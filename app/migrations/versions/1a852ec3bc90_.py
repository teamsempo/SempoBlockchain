...
def upgrade():
    ...
    op.create_foreign_key("user_default_transfer_account_id_fkey", 'user', 'transfer_account', ['default_transfer_account_id'], ['id'])
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("user_default_transfer_account_id_fkey", 'user', type_='foreignkey')
