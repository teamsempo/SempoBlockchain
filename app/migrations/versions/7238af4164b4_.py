...
def upgrade():
    ...
    op.create_index(op.f('ix_credit_transfer_created'), 'credit_transfer', ['created'], unique=False)
    op.create_index(op.f('ix_credit_transfer_recipient_blockchain_address_id'), 'credit_transfer', ['recipient_blockchain_address_id'], unique=False)
    op.create_index(op.f('ix_credit_transfer_recipient_transfer_account_id'), 'credit_transfer', ['recipient_transfer_account_id'], unique=False)
    op.create_index(op.f('ix_credit_transfer_recipient_user_id'), 'credit_transfer', ['recipient_user_id'], unique=False)
    op.create_index(op.f('ix_credit_transfer_sender_blockchain_address_id'), 'credit_transfer', ['sender_blockchain_address_id'], unique=False)
    op.create_index(op.f('ix_credit_transfer_sender_transfer_account_id'), 'credit_transfer', ['sender_transfer_account_id'], unique=False)
    op.create_index(op.f('ix_credit_transfer_transfer_mode'), 'credit_transfer', ['transfer_mode'], unique=False)
    op.create_index(op.f('ix_custom_attribute_user_storage_user_id'), 'custom_attribute_user_storage', ['user_id'], unique=False)
    op.create_index(op.f('ix_transfer_account__balance_wei'), 'transfer_account', ['_balance_wei'], unique=False)
    op.create_index(op.f('ix_transfer_account_account_type'), 'transfer_account', ['account_type'], unique=False)
    op.create_index(op.f('ix_transfer_account_created'), 'transfer_account', ['created'], unique=False)
    op.create_index(op.f('ix_transfer_account_token_id'), 'transfer_account', ['token_id'], unique=False)
    ...
    op.create_index(op.f('ix_user_default_organisation_id'), 'user', ['default_organisation_id'], unique=False)
    op.create_index(op.f('ix_user_default_transfer_account_id'), 'user', ['default_transfer_account_id'], unique=False)
