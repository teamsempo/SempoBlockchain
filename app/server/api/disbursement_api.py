...
from server.schemas import transfer_account_schema, disbursement_schema, disbursements_schema, credit_transfers_schema
...
class DisbursementAPI(MethodView):
    ...
    def get(self, disbursement_id):
        transfers = db.session.query(TransferAccount)\
        ...
        transfer_accounts = transfer_account_schema.dump(transfers).data
