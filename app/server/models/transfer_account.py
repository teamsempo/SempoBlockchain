...
class TransferAccount(OneOrgBase, ModelBase, SoftDelete):
    ...
    credit_sends       = db.relationship('CreditTransfer', foreign_keys='CreditTransfer.sender_transfer_account_id')

    credit_receives    = db.relationship('CreditTransfer', foreign_keys='CreditTransfer.recipient_transfer_account_id')
