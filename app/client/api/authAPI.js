...
export const ValidateTFAAPI = ({ body }) =>
  apiClient({ url: '/auth/tfa/', method: 'POST', body });

export const ResetPasswordAPI = ({ body }) =>
  apiClient({ url: '/auth/reset_password/', method: 'POST', body });
...
export const deleteInviteAPI = ({ body }) =>
  apiClient({ url: '/auth/permissions/', method: 'DELETE', body });

export const inviteUserAPI = ({ body }) =>
  apiClient({ url: '/auth/permissions/', method: 'POST', body });
