...
export const LOAD_CREDIT_TRANSFER_FILTERS_REQUEST = "LOAD_CREDIT_TRANSFER_FILTERS_REQUEST";
export const LOAD_CREDIT_TRANSFER_FILTERS_SUCCESS = "LOAD_CREDIT_TRANSFER_FILTERS_SUCCESS";
export const LOAD_CREDIT_TRANSFER_FILTERS_FAILURE = "LOAD_CREDIT_TRANSFER_FILTERS_FAILURE";
