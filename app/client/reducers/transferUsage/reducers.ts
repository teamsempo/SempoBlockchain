...
import {
  ...
  LOAD_TRANSFER_USAGES_REQUEST, LOAD_TRANSFER_USAGES_SUCCESS,
...
const loadStatus = (state = initialLoadStatusState, action: LoadTransferUsagesAction): LoadTransferUsageState => {
  switch (action.type) {
