...
export interface RegisterInactive {
  type: typeof REGISTER_INACTIVE;
}
...
interface ResetEmailSuccess {
  type: typeof REQUEST_RESET_SUCCESS;
}
...
interface LoadAdminUserListRequest {
  type: typeof LOAD_ADMIN_USER_REQUEST;
}
...
interface UpdateUserSuccess {
  type: typeof EDIT_ADMIN_USER_SUCCESS;
}
...
interface ValidateTfaSuccess {
  type: typeof VALIDATE_TFA_SUCCESS;
}
