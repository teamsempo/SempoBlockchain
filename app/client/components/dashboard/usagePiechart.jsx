...
const mapStateToProps = state => {
  return {
    creditTransfers: Object.keys(state.creditTransfers.byId).map(
      id => state.creditTransfers.byId[id]
    )
  };
};
...
class useagePieChart extends React.Component {
  ...
  render() {
    const filterCreditTransferList = this.props.creditTransfers.filter(
      transfer => transfer.transfer_type === "PAYMENT"
    );
