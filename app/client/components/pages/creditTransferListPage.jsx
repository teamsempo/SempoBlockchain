...
const mapStateToProps = (state) => {
  return {
    ...
    creditTransferList:
      Object.keys(state.creditTransfers.byId)
...
class CreditTransferListPage extends React.Component {
  ...
  render() {
    ...
    if (isNoData && this.props.creditTransfers.loadStatus.isRequesting !== true) {
      return(
        <PageWrapper>
            <ModuleBox>
                <NoDataMessageWrapper>
      ...
      <WrapperDiv>
          <PageWrapper>
              <ThemeProvider theme={LightTheme}>
                <CreditTransferListWithFilterWrapper creditTransferList={this.props.creditTransferList}/>
              </ThemeProvider>
          </PageWrapper>
      </WrapperDiv>
    );
