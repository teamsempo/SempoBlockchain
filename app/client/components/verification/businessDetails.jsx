...
class BusinessDetails extends React.Component {
  ...
  componentDidMount() {
    ...
    if (businessProfile !== null && typeof businessProfile !== 'undefined') {
      Object.keys(this.state).map(key => {
        if (businessProfile[key] !== null && typeof businessProfile[key] !== 'undefined') {
  ...
  _validationErrors(val) {
    const errMsgs = {
      ...
      date_established_val_msg: val.date_established ? '' : 'Please provide establishment date as dd/mm/yyyy',
      country_val_msg: val.country ? '' : 'Please select a country',
      street_address_val_msg: val.street_address ? '' : 'Please provide your street address',
      city_val_msg: val.city ? '' : 'Please provide a city',
      region_val_msg: val.region ? '' : 'Please select a region',
      postal_code_val_msg: val.postal_code ? '' : 'Please provide a postal code',
      beneficial_owners_val_msg: val.beneficial_owners ? '' : 'Please add at least one beneficial owner'
    };
    return errMsgs;
  }
        ...
        <div>
          ...
          {indvidualAccount ? null : <div><Row>
            <InputObject>
              ...
              <ManagerInput
                ...
                onBlur={this.validationCheck}
                onChange={this.handleInputChange} />
              <ErrorMessage state={this.state} input={'business_legal_name'}/>
            </InputObject>
          </Row>
          ...
          <Row>
            <InputObject>
              ...
              <StyledSelectKey name="business_type" value={this.state.business_type} onBlur={this.validationCheck} onChange={this.handleInputChange}>
                <option name="select" value="select" disabled>select attribute</option>
                <option name="partnership" value="partnership">General Partnership</option>
                <option name="for_profit" value="for_profit">For-Profit Corporation</option>
                <option name="limited_company" value="limited_company">Limited Company</option>
                <option name="llc" value="llc">Limited Liability Company (LLC)</option>
                <option name="llp" value="llp">Limited Liability Partnership (LLP)</option>
                <option name="lp" value="lp">Limited Partnership (LP)</option>
                <option name="non_profit" value="non_profit">Non-for Profit</option>
