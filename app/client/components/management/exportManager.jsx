...
import {Input, StyledButton, ErrorMessage, ModuleHeader, StyledSelect, ModuleBox} from '../styledElements'
        ...
        <div>
          ...
          <div style={{margin: '1em'}}>
            ...
            <div style={{display: 'flex', flexDirection: 'row', padding: '1em 0'}}>
              ...
              <StyledSelect style={{fontWeight: '400', margin: '0 1em', lineHeight: '25px', height: '25px'}} name="account_type" value={this.state.account_type} onChange={this.handleChange}>
                <option name="account_type" value="VENDOR">VENDORS</option>
                <option name="account_type" value={window.BENEFICIARY_TERM}>{window.BENEFICIARY_TERM_PLURAL}</option>
                <option name="account_type" value="SELECTED">SELECTED</option>
              </StyledSelect>
            </div>
            {/*<div>*/}
              {/*<div style={{display: 'flex', flexDirection: 'row', padding: '1em 0'}}>*/}
            ...
            {/*</div>*/}
            <div style={{display: 'flex', flexDirection: 'row', padding: '1em 0'}}>
              <p style={{margin: '0 1em 0 0'}}>Include transfers?</p><input name='includeTransfers' type="checkbox" checked={this.state.includeTransfers} onChange={(evt) => this.handleToggle(evt, this.state.includeTransfers)}/>
            </div>
            <AsyncButton
            ...
            <a href={this.props.newExportRequest.file_url} target="_blank" style={{display: ((this.props.newExportRequest.file_url === null) ? 'none' : '')}}>Didn't automatically download?</a>
          </div>
        </div>
    );
  }
